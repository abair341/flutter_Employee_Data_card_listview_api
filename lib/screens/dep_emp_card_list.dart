                    ...
                    return Card(
                      ...
                      margin: EdgeInsets.all(0),
                           ...
                           Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  Expanded(child: Text("${snapshot.data[index].departmentname}")),
                                  Expanded(child: Text("${snapshot.data[index].employeename}")),
                                  Expanded(child: Text("${snapshot.data[index].employeeid}")),
                                  Expanded(child: Text("${snapshot.data[index].employeesalary}"))
                                ],
                              ),
                            ),                            
                    ); 
